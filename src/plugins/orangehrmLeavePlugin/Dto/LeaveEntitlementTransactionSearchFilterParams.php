...
class LeaveEntitlementTransactionSearchFilterParams extends FilterParams
{
    public const ALLOWED_SORT_FIELDS = ['txn.createdAt', 'txn.transactionType'];

    protected ?int $empNumber = null;
    protected ?int $leaveTypeId = null;
    ...
    {
        $this->setSortField('txn.createdAt');
